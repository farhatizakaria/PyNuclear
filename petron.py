...
class Nuclear():
    ...
    def Fragmentation_nucleus(self): # The energy from fragmentation of nucleus
    ...
    def decreasing_radiation(self): #STILL UNDER-DEVELOPMENT !!!!
...
command() #The second thing will be run after def__init__(self)
